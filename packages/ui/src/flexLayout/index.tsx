 ...
 */
const FlexLayoutRender: ForwardRefRenderFunction<Layout, IBaseFlexLayoutProps> = (
  { model, json, factory, className, ...rest },
  ref,
) => {
...
export const BaseFlexLayout: FC<IBaseFlexLayoutProps> = forwardRef(FlexLayoutRender) as unknown as FC<
