    ...
    modalId = ClickModal.open({
      ...
      content: (
        <div>
          <p>点击按钮可以关闭我</p>
          <button
            onClick={() => ClickModal.close(modalId)}
            style={{ marginTop: 10 }}
          >
            关闭弹窗
          </button>
    ...
    const modalId1 = ClickModal.open({
      ...
      content: (
        <div>
          <p>我是第一个弹窗</p>
          <button
            onClick={() => ClickModal.close(modalId1)}
            style={{ marginTop: 10 }}
          >
            关闭我
          </button>
      ...
      const modalId2 = ClickModal.open({
        ...
        content: (
          <div>
            <p>我是第二个弹窗</p>
            <button
              onClick={() => ClickModal.close(modalId2)}
              style={{ marginTop: 10 }}
            >
              关闭我
            </button>
      ...
      const modalId3 = ClickModal.open({
        ...
        content: (
          <div>
            <p>我是第三个弹窗</p>
            <button
              onClick={() => ClickModal.close(modalId3)}
              style={{ marginTop: 10 }}
            >
              关闭我
            </button>
            <button
              onClick={() => ClickModal.closeAll()}
